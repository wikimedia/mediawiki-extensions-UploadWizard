...
class ApiQueryUploadCampaigns extends ApiQueryORM {
	...
	protected function getExamples() {
		return array (
			'api.php?action=query&list=uploadcampaigns&campaigns=wlm-nl&ucprop=config'
			=> 'Get the info and all configuration of the wlm-nl campaign.',
			'api.php?action=query&list=uploadcampaigns&campaigns=wlm-nl|wlm-de&ucprop=config'
			=> 'Get the info and all configuration of the wlm-nl and wlm-de campaigns.',
			'api.php?action=query&list=uploadcampaigns&campaigns=42'
