...
$messages['be-tarask'] = array(
	...
	'mwe-upwiz-deeds-intro' => 'Гэты сайт патрабуе ад Вас пазначэньня ліцэнзіі на файлы, якія загружаюцца, каб кожны мог легальна выкарыстоўваць іх у любых мэтаў.',
	...
	'mwe-upwiz-source-ownwork-assert' => 'Я, $2, уладальнік аўтарскіх правоў на {{PLURAL:$1|гэтую працу|гэтыя працы}}, дабравольна перадаю правы на выкарыстаньне {{PLURAL:$1|гэтай працы ў|гэтых прац у}} любых мэтаў, на ўмовах указаньня аўтарства і выкарыстаньня вытворных працаў на гэткіх жа ўмовах.',
...
Не карыстайцеся ў ім вікі-фарматаваньнем ці HTML, пакіньце толькі сапраўднае імя ці імя ўдзельніка.',
...
Не карыстайцеся ў ім вікі-фарматаваньнем ці HTML.',
