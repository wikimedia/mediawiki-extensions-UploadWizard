...
$messages['be-tarask'] = array(
	...
	'mwe-upwiz-tooltip-title' => 'Кароткая ўнікальная назва файла. Вы можаце выкарыстоўваць звычайны тэкст з прагаламі. Не пазначайце пашырэньне. [$1 Падрабязьней].',
...
V obou případech odtud povede odkaz na vaši stránku na wiki.',
	'mwe-upwiz-tooltip-title' => 'Krátký unikátní název tohoto souboru. Můžete použít běžný jazyk i s mezerami. Nevkládejte příponu souboru. [$1 Více informací]',
...
$messages['de'] = array(
	...
	'mwe-upwiz-tooltip-title' => 'Ein kurzer Titel für die Datei. Normaler Text einschließlich Leerzeichen ist dabei möglich. Die Dateierweiterung darf aber nicht angegeben werden. [$1 Mehr erfahren].',
...
Êtes-vous sûr de vouloir quitter cette page ?',
	...
	'mwe-upwiz-tooltip-title' => "Un court et unique titre pour le fichier. Utilisez un langage simple avec des espaces. N'inscrivez pas l'extension du fichier. [$1 Pour en savoir plus].",
...
En calquera caso, haberá unha ligazón cara a súa páxina de usuario do wiki.',
	'mwe-upwiz-tooltip-title' => 'Un título curto e único para o ficheiro. Sería bo utilizar unha lingua sinxela con espazos. Non inclúa a extensión do ficheiro. [$1 Máis información].',
...
Bisch sicher, ass Du e anderi Syte witt ufruefe?',
	...
	'mwe-upwiz-tooltip-title' => 'E churze Titel fir d Datei. Du chasch doderby normale Text un au Läärzeiche verwände. D Dateierwyterig derf aber nit aagee wäre. [$1 Meh Informatione].',
...
בשני המקרים, זה יקושר לדף המשתמש שלך בוויקי',
	'mwe-upwiz-tooltip-title' => 'כותרת קצרה וייחודית לקובץ. אפשר להשתמש בשפה פשוטה עם רווחים. אין לכלול סיומת קובץ. [$1 למידע נוסף].',
...
We woběmaj padomaj budźe so to k twojej wužiwarskej stronje wotkazować.',
	'mwe-upwiz-tooltip-title' => 'Krótki jónkróćny titul za dataju. Móžeš połnu rěč z mjezerami wužiwać. Njezapřijimaj datajowy sufiks. [$1 Dalše informacije].',
...
$messages['ia'] = array(
	...
	'mwe-upwiz-tooltip-title' => 'Un titulo curte e unic pro le file. Tu pote usar linguage simple con spatios. Non includer le extension del nomine del file. [$1 Leger plus].',
...
Untuk kedua nama akan dihubungkan ke halaman pengguna wiki Anda.',
	'mwe-upwiz-tooltip-title' => 'Judul singkat yang unik untuk berkas. Anda dapat menggunakan bahasa sederhana dengan spasi. Jangan menyertakan ekstensi berkas. [$1 Pelajari lebih lanjut] .',
...
In entrambi i casi, sarà collegato con un link alla tua pagina utente della wiki',
	'mwe-upwiz-tooltip-title' => "Un titolo breve e distintivo per il file. Puoi usare un linguaggio semplice con spazi. Non includere l'estensione del file. [$1 Ulteriori informazioni].",
...
どちらの場合でも、ウィキの利用者ページへリンクされます。',
	'mwe-upwiz-tooltip-title' => 'ファイル固有の短いタイトル。拡張子は含めないで、平易な言葉を使用してください。[$1 詳細はこちら]。',
...
An deene zwee Fäll, gëtt et mat Ärer Wiki-Benotzersäit verlinkt.',
	'mwe-upwiz-tooltip-title' => "E kuerzen Titel fir de Fichier, deen anescht ass wéi all déi aner op dëser Wiki. Dir kënnt dobäi Text mat Espace benotzen. D'Erweiderung vum Fichier soll net ugi ginn. [$1 Fir méi ze wëssen].",
...
или пак да ја [{{fullurl:{{FULLPAGENAME}}|action=edit}} уредите страницава]</span>.',
	...
	'mwe-upwiz-tooltip-title' => 'Краток и единствен наслов на податотеката. Можете да користите прост јазик со меѓупростор, но не пишувајте ја податотечната наставка. [$1 Дознајте повеќе].',
...
ഇരു അവസരങ്ങളിലും, താങ്കളുടെ വിക്കി ഉപയോക്തൃതാളിലേയ്ക്ക് കണ്ണി ചേർക്കപ്പെടുന്നതാണ്.',
	'mwe-upwiz-tooltip-title' => 'പ്രമാണത്തിനുള്ള ചെറിയ അനന്യമായ തലക്കെട്ട്. വാക്കുകൾക്കിടയിൽ ഇടവിട്ടുള്ള ലളിതഭാഷ ഉപയോഗിക്കാം. പ്രമാണത്തിന്റെ എക്സ്റ്റെൻഷൻ ഉൾപ്പെടുത്തരുത്. [$1 കൂടുത അറിയുക].',
...
Probeer het later opnieuw.',
	...
	'mwe-upwiz-tooltip-title' => 'Een korte naam voor het bestand. U kunt platte tekst met spaties gebruiken. Neem de bestandsextensie niet op. [$1 Meer informatie].',
...
W obu przypadkach link będzie prowadził do Twojej strony użytkownika.',
	'mwe-upwiz-tooltip-title' => 'Krótka unikalna nazwa pliku. Możesz użyć prostego języka i spacji. Nie dodawaj rozszerzenia pliku. [$1 Więcej informacji].',
...
$messages['pt'] = array(
	...
	'mwe-upwiz-tooltip-title' => 'Um título curto e único para o ficheiro. Pode usar linguagem simples com espaços. Não inclua a extensão do ficheiro. [$1 Ler mais].',
...
$messages['ru'] = array(
	...
	'mwe-upwiz-tooltip-title' => 'Краткое уникальное название файла. Вы можете использовать простой текст с пробелами. Не указывайте расширение. [$1 Подробнее].',
...
V obeh primerih bo vpisano ime povezano na vašo uporabniško stran na wikiju.',
	'mwe-upwiz-tooltip-title' => 'Kratek edinstven naslov datoteke. Uporabljate lahko navaden jezik s presledki. Ne vključujte datotečne končnice. [$1 Več informacij].',
...
Sa parehong pagkakataon, ikakawing ito sa iyong pahina ng tagagamit sa wiki.',
	'mwe-upwiz-tooltip-title' => 'Isang maliit na natatanging pamagat para sa talaksan.  Maaari kang gumamit ng payak na wika na may mga patlang.  Huwag isama ang dugtong ng talaksan. [$1 Dagdagan pa ang nalalaman].',
...
Para sa isang larawan, banggitin ang pangunahing mga bagay na nilalarawan, ang okasyon, o ang lugar.',
	...
	'mwe-upwiz-tooltip-other' => 'Anumang ibang kabatiran na nais mong isama hinggil sa akdang ito.  Maglagay ng mga suleras ng <a target="_blank" href="http://commons.wikimedia.org/wiki/Commons:Geocoding">pagkokodigong pangheograpiya</a> rito.',
...
Mangyaring huwag gumamit ng wikiteksto o HTML dito.',
	...
	'mwe-upwiz-license-cc-by-sa-3.0' => 'Creative Commons Attribution ShareAlike 3.0',
	'mwe-upwiz-license-cc-by-3.0' => 'Creative Commons Attribution 3.0',
	'mwe-upwiz-license-cc-zero' => 'Pang-urong ng Creative Commons CC0',
...
Dù sao, tên này sẽ được liên kết đến trang cá nhân của bạn trên wiki.',
	'mwe-upwiz-tooltip-title' => 'Tên ngắn và duy nhất cho tập tin. Có thể dùng thuật ngữ bình thường với khoảng cách. Đừng bao gồm phần mở rộng tập tin. [$1 Tìm hiểu thêm].',
...
在这两种情况下，这将连结到你在维基的用户页',
	'mwe-upwiz-tooltip-title' => '一个此档案的短标题。你可以使用简单文字说明，可以使用空格。不需要添加扩展名。[$1 详细了解]。
