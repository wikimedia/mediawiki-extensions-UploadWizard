...
$messages['ja'] = array(
	...
	'mwe-upwiz-api-error-missingparam' => 'アップロードに全ての必要な情報が含まれていませんでした（おそらく、このアップロード機能のバグです）。',
	...
	'mwe-upwiz-api-error-unknown-error' => '何か（詳しくは不明）が、ファイルをアップロードする時に問題を発生させました。',
	'mwe-upwiz-api-error-internal-error' => 'ウィキでのアップロードの処理で何か問題が発生しました。',
	'mwe-upwiz-api-error-overwrite' => '既存のファイルへ上書きすることは許可されていません。',
	'mwe-upwiz-api-error-badtoken' => 'サーバーと接続元を識別する「トークン」が不正でした。',
	...
	'mwe-upwiz-add-file-0-free' => 'メディアファイルを選択して寄付',
	'mwe-upwiz-browse' => '参照...',
	...
	'mwe-upwiz-file-all-failed' => 'すべてのアップロードが成功しませんでした。',
